...
// Initialize Google Map with order data
// function initMap() {
...
//             let buyerLocation = { lat: 40.7128, lng: -74.0060 };
//             let sellerLocation = { lat: 34.0522, lng: -118.2437 };

//             if (data.shippingInfo?.latitude && data.shippingInfo?.longitude) {
//                 buyerLocation = {
//                     lat: parseFloat(data.shippingInfo.latitude),
//                     lng: parseFloat(data.shippingInfo.longitude)
//                 };
//             }
...
//                 path: [sellerLocation, currentLocation, buyerLocation],
//                 geodesic: true,
//                 strokeColor: "#3498db",
//                 strokeOpacity: 1.0,
//                 strokeWeight: 3,
